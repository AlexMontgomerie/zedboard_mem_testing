...
HD_PWD='/home/juju/mem_test_rw_seperate/mem_test_rw_seperate.runs/design_1_mem_read_hw_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_mem_read_hw_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_mem_read_hw_0_0.tcl
