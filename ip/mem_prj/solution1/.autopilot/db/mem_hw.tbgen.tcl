set C_TypeInfoList {{ 
"mem_hw" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"out": [[], {"reference": "0"}] }, {"in": [[], {"reference": "0"}] }, {"rw": [[], {"scalar": "int"}] }, {"mask": [[], {"scalar": "long unsigned int"}] }, {"test_init_arr": [[], {"array": ["1", [512]]}] }],[],""], 
...
set C_modelArgMapList {[ 
	{ "Name" : "out_V_data_V", "interface" : "axis", "bitwidth" : 64, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "out.V.data.V","cData": "uint64","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "test_init_arr_V", "interface" : "axi_slave", "bundle":"CONTROL_BUS","type":"ap_memory","bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "test_init_arr.V","cData": "uint64","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 0,"up" : 511,"step" : 1}]}]}], "offset" : {"in":4096}, "offset_end" : {"in":8191}} ]}
# RTL Port declarations: 
set portNum 38
set portList { 
	{ s_axi_CONTROL_BUS_AWVALID sc_in sc_logic 1 signal -1 } 
	{ s_axi_CONTROL_BUS_AWREADY sc_out sc_logic 1 signal -1 } 
	{ s_axi_CONTROL_BUS_AWADDR sc_in sc_lv 13 signal -1 } 
	...
	{ s_axi_CONTROL_BUS_ARADDR sc_in sc_lv 13 signal -1 } 
...
set NewPortList {[ 
	{ "name": "s_axi_CONTROL_BUS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "CONTROL_BUS", "role": "AWADDR" },"address":[{"name":"mem_hw","role":"start","value":"0","valid_bit":"0"},{"name":"mem_hw","role":"continue","value":"0","valid_bit":"4"},{"name":"mem_hw","role":"auto_start","value":"0","valid_bit":"7"},{"name":"rw","role":"data","value":"16"},{"name":"mask","role":"data","value":"24"},{"name":"test_init_arr_V","role":"data","value":"4096"}] },
	...
	{ "name": "s_axi_CONTROL_BUS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "CONTROL_BUS", "role": "ARADDR" },"address":[{"name":"mem_hw","role":"start","value":"0","valid_bit":"0"},{"name":"mem_hw","role":"done","value":"0","valid_bit":"1"},{"name":"mem_hw","role":"idle","value":"0","valid_bit":"2"},{"name":"mem_hw","role":"ready","value":"0","valid_bit":"3"},{"name":"mem_hw","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "262147", "Max" : "262147"}
