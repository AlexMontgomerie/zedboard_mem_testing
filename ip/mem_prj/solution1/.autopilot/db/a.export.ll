...
define internal fastcc void @mem_write(i64* %out_stream_V_data_V, i8* %out_stream_V_keep_V, i8* %out_stream_V_strb_V, i1* %out_stream_V_user_V, i1* %out_stream_V_last_V, i1* %out_stream_V_id_V, i1* %out_stream_V_dest_V, [256 x i64]* nocapture %test_init_arr_V) {
...
.reset:                                           ; preds = %1
  ...
  %tmp_mid2 = call i20 @_ssdm_op_BitConcatenate.i20.i12.i8(i12 %tmp_mid2_v_v, i8 0)
  ...
  %tmp_2 = add i20 %j_cast3, %tmp_mid2
  %tmp_last_V = icmp eq i20 %tmp_2, -257
  %tmp_4 = zext i9 %j_mid2 to i64
  %test_init_arr_V_addr = getelementptr [256 x i64]* %test_init_arr_V, i64 0, i64 %tmp_4
...
define void @mem_hw(i64* %out_V_data_V, i8* %out_V_keep_V, i8* %out_V_strb_V, i1* %out_V_user_V, i1* %out_V_last_V, i1* %out_V_id_V, i1* %out_V_dest_V, i64* %in_V_data_V, i8* %in_V_keep_V, i8* %in_V_strb_V, i1* %in_V_user_V, i1* %in_V_last_V, i1* %in_V_id_V, i1* %in_V_dest_V, i32 %rw, i64 %mask, [256 x i64]* %test_init_arr_V) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap([256 x i64]* %test_init_arr_V), !map !120
  ...
  call fastcc void @mem_write(i64* %out_V_data_V, i8* %out_V_keep_V, i8* %out_V_strb_V, i1* %out_V_user_V, i1* %out_V_last_V, i1* %out_V_id_V, i1* %out_V_dest_V, [256 x i64]* %test_init_arr_V)
  ret void
}
...
!125 = metadata !{i32 0, i32 255, i32 1}
