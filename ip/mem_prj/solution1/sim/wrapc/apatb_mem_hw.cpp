...
extern void mem_hw (
hls::stream<ap_axiu<64, 1, 1, 1 > > (&out),
hls::stream<ap_axiu<64, 1, 1, 1 > > (&in),
int rw,
long unsigned int mask,
ap_uint<64> test_init_arr[512]);
...
ap_uint<64> test_init_arr[512])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			std::vector<sc_bv<64> > out_V_data_V_pc_buffer;
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: out_V_data_V
				{
					// bitslice(63, 0)
					// {
						// celement: out.V.data.V(63, 0)
						// {
							sc_lv<64>* out_V_data_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<64>[aesl_tmp_1 - aesl_tmp_2];
						// }
					// }
						...
						// celement: out.V.data.V(63, 0)
						{
							...
							for (int i_0 = aesl_tmp_2; i_0 <= aesl_tmp_1 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									{
										out_V_data_V_lv0_0_0_1_lv1_0_0_1[hls_map_index].range(63, 0) = sc_bv<64>(out_V_data_V_pc_buffer[hls_map_index].range(63, 0));
										hls_map_index++;
									}
								}
							}
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			std::vector<sc_bv<8> > out_V_keep_V_pc_buffer;
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: out_V_keep_V
				{
					// bitslice(7, 0)
					// {
						// celement: out.V.keep.V(7, 0)
						// {
							sc_lv<8>* out_V_keep_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<8>[aesl_tmp_1 - aesl_tmp_2];
						// }
					// }
						...
						// celement: out.V.keep.V(7, 0)
						{
							...
							for (int i_0 = aesl_tmp_2; i_0 <= aesl_tmp_1 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									{
										out_V_keep_V_lv0_0_0_1_lv1_0_0_1[hls_map_index].range(7, 0) = sc_bv<8>(out_V_keep_V_pc_buffer[hls_map_index].range(7, 0));
										hls_map_index++;
									}
								}
							}
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			std::vector<sc_bv<8> > out_V_strb_V_pc_buffer;
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: out_V_strb_V
				{
					// bitslice(7, 0)
					// {
						// celement: out.V.strb.V(7, 0)
						// {
							sc_lv<8>* out_V_strb_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<8>[aesl_tmp_1 - aesl_tmp_2];
						// }
					// }
						...
						// celement: out.V.strb.V(7, 0)
						{
							...
							for (int i_0 = aesl_tmp_2; i_0 <= aesl_tmp_1 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									{
										out_V_strb_V_lv0_0_0_1_lv1_0_0_1[hls_map_index].range(7, 0) = sc_bv<8>(out_V_strb_V_pc_buffer[hls_map_index].range(7, 0));
										hls_map_index++;
									}
								}
							}
	...
	else
	{
		...
		// dump stream tvin: "in"
		std::vector<ap_axiu<64, 1, 1, 1 > > aesl_tmp_3;
		int aesl_tmp_4 = 0;
		while (!in.empty())
		{
		...
		sc_bv<64>* test_init_arr_V_tvin_wrapc_buffer = new sc_bv<64>[512];
			...
			// bitslice(63, 0)
			{
				...
				// celement: test_init_arr.V(63, 0)
				{
					...
					for (int i_0 = 0; i_0 <= 511; i_0 += 1)
					{
						...
						{
							sc_lv<64> test_init_arr_V_tmp_mem;
							test_init_arr_V_tmp_mem = (test_init_arr[i_0]).to_string(2).c_str();
							test_init_arr_V_tvin_wrapc_buffer[hls_map_index].range(63, 0) = test_init_arr_V_tmp_mem.range(63, 0);
                                 	       hls_map_index++;
						}
					}
				}
...
// [call_c_dut] ---------->
     ...
     aesl_tmp_0.clear();
		...
		sc_bv<64>* out_V_data_V_tvout_wrapc_buffer = new sc_bv<64>[aesl_tmp_1 - aesl_tmp_2];
				...
				// celement: out.V.data.V(63, 0)
				{
					...
					for (int i_0 = aesl_tmp_2; i_0 <= aesl_tmp_1 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_0[0].data) != NULL) // check the null address if the c port is array or others
							{
								sc_lv<64> out_V_data_V_tmp_mem;
								out_V_data_V_tmp_mem = (aesl_tmp_0[i_0].data).to_string(2).c_str();
								out_V_data_V_tvout_wrapc_buffer[hls_map_index].range(63, 0) = out_V_data_V_tmp_mem.range(63, 0);
                                 		       hls_map_index++;
							}
						}
					}
		...
		sc_bv<8>* out_V_keep_V_tvout_wrapc_buffer = new sc_bv<8>[aesl_tmp_1 - aesl_tmp_2];
				...
				// celement: out.V.keep.V(7, 0)
				{
					...
					for (int i_0 = aesl_tmp_2; i_0 <= aesl_tmp_1 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_0[0].keep) != NULL) // check the null address if the c port is array or others
							{
								sc_lv<8> out_V_keep_V_tmp_mem;
								out_V_keep_V_tmp_mem = (aesl_tmp_0[i_0].keep).to_string(2).c_str();
								out_V_keep_V_tvout_wrapc_buffer[hls_map_index].range(7, 0) = out_V_keep_V_tmp_mem.range(7, 0);
                                 		       hls_map_index++;
							}
						}
					}
		...
		sc_bv<8>* out_V_strb_V_tvout_wrapc_buffer = new sc_bv<8>[aesl_tmp_1 - aesl_tmp_2];
				...
				// celement: out.V.strb.V(7, 0)
				{
					...
					for (int i_0 = aesl_tmp_2; i_0 <= aesl_tmp_1 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_0[0].strb) != NULL) // check the null address if the c port is array or others
							{
								sc_lv<8> out_V_strb_V_tmp_mem;
								out_V_strb_V_tmp_mem = (aesl_tmp_0[i_0].strb).to_string(2).c_str();
								out_V_strb_V_tvout_wrapc_buffer[hls_map_index].range(7, 0) = out_V_strb_V_tmp_mem.range(7, 0);
                                 		       hls_map_index++;
							}
						}
					}
		...
		sc_bv<64>* in_V_data_V_tvin_wrapc_buffer = new sc_bv<64>[aesl_tmp_4 - aesl_tmp_5];
				...
				// celement: in.V.data.V(63, 0)
				{
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_4 - aesl_tmp_5 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							{
								sc_lv<64> in_V_data_V_tmp_mem;
								in_V_data_V_tmp_mem = (aesl_tmp_3[i_0].data).to_string(2).c_str();
								in_V_data_V_tvin_wrapc_buffer[hls_map_index].range(63, 0) = in_V_data_V_tmp_mem.range(63, 0);
                                 		       hls_map_index++;
							}
						}
					}
		...
		sc_bv<8>* in_V_keep_V_tvin_wrapc_buffer = new sc_bv<8>[aesl_tmp_4 - aesl_tmp_5];
				...
				// celement: in.V.keep.V(7, 0)
				{
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_4 - aesl_tmp_5 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							{
								sc_lv<8> in_V_keep_V_tmp_mem;
								in_V_keep_V_tmp_mem = (aesl_tmp_3[i_0].keep).to_string(2).c_str();
								in_V_keep_V_tvin_wrapc_buffer[hls_map_index].range(7, 0) = in_V_keep_V_tmp_mem.range(7, 0);
                                 		       hls_map_index++;
							}
						}
					}
		...
		sc_bv<8>* in_V_strb_V_tvin_wrapc_buffer = new sc_bv<8>[aesl_tmp_4 - aesl_tmp_5];
				...
				// celement: in.V.strb.V(7, 0)
				{
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_4 - aesl_tmp_5 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							{
								sc_lv<8> in_V_strb_V_tmp_mem;
								in_V_strb_V_tmp_mem = (aesl_tmp_3[i_0].strb).to_string(2).c_str();
								in_V_strb_V_tvin_wrapc_buffer[hls_map_index].range(7, 0) = in_V_strb_V_tmp_mem.range(7, 0);
                                 		       hls_map_index++;
							}
						}
					}
