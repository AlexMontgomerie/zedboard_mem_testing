...
struct mem_write : public sc_module {
    ...
    sc_signal< sc_lv<20> > indvar_flatten_reg_130;
    sc_signal< sc_lv<12> > i_reg_141;
    sc_signal< sc_lv<1> > tmp_user_V_reg_152;
    sc_signal< sc_lv<9> > j_reg_167;
    ...
    sc_signal< sc_lv<20> > indvar_flatten_next_fu_184_p2;
    ...
    sc_signal< sc_lv<9> > j_1_fu_247_p2;
    ...
    sc_signal< sc_lv<9> > j_mid2_fu_196_p3;
    sc_signal< sc_lv<20> > j_cast3_fu_226_p1;
    sc_signal< sc_lv<20> > tmp_mid2_fu_218_p3;
    sc_signal< sc_lv<20> > tmp_2_fu_230_p2;
