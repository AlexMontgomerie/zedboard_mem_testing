...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(s_axi_CONTROL_BUS_AWADDR, 
  ...
  in_r_TLAST, in_r_TID)
/* synthesis syn_black_box black_box_pad_pin="s_axi_CONTROL_BUS_AWADDR[15:0],s_axi_CONTROL_BUS_AWVALID,s_axi_CONTROL_BUS_AWREADY,s_axi_CONTROL_BUS_WDATA[31:0],s_axi_CONTROL_BUS_WSTRB[3:0],s_axi_CONTROL_BUS_WVALID,s_axi_CONTROL_BUS_WREADY,s_axi_CONTROL_BUS_BRESP[1:0],s_axi_CONTROL_BUS_BVALID,s_axi_CONTROL_BUS_BREADY,s_axi_CONTROL_BUS_ARADDR[15:0],s_axi_CONTROL_BUS_ARVALID,s_axi_CONTROL_BUS_ARREADY,s_axi_CONTROL_BUS_RDATA[31:0],s_axi_CONTROL_BUS_RRESP[1:0],s_axi_CONTROL_BUS_RVALID,s_axi_CONTROL_BUS_RREADY,ap_clk,ap_rst_n,interrupt,out_r_TVALID,out_r_TREADY,out_r_TDATA[63:0],out_r_TDEST[0:0],out_r_TKEEP[7:0],out_r_TSTRB[7:0],out_r_TUSER[0:0],out_r_TLAST[0:0],out_r_TID[0:0],in_r_TVALID,in_r_TREADY,in_r_TDATA[63:0],in_r_TDEST[0:0],in_r_TKEEP[7:0],in_r_TSTRB[7:0],in_r_TUSER[0:0],in_r_TLAST[0:0],in_r_TID[0:0]" */;
